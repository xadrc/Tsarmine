...
var_1		 	<- df_modelvar $ precipitations
var_1a <- var_1
var_1a [ var_1a >= 6 ] <- NA
var_1_name 		<- "precipitations"
var_1_unit 		<- "mm/h"
var_1_breaks	<-  seq(0, 10, 1)

#	model
model_name		<- "Precipitation effects"
model_formulae	<- response ~ var_1a
...
quartz.save(
    file = file.path(dir_plt, "models", "mdl_42.png"),
    type = "png",
    dpi = 300
)
