...
var_1			<- df_modelvar $ temp_wo_htsp
var_1_name 		<- "air temperatures"
var_1_unit 		<- "°C"
var_1_breaks	<-  seq(-20, 30, 5)

var_2			<- df_modelvar $ htemp_w_snowpack
var_2_name 		<- "air temperatures w/ snowpack"
var_2_unit 		<- "°C"
var_2_breaks	<-  seq(0, 25, 5/2)

#	model
model_name		<- "Air temperatures and positive temperatures in presence of a snowpack"
...
quartz.save(
    file = file.path(dir_plt, "models", "mdl_46.png"),
    type = "png",
    dpi=300
)
